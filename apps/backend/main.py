...
origins = [
    ...
    "http://127.0.0.1:5173",
    "http://127.0.0.1:3000",
    "https://pinkfit-frontend.vercel.app",  # Production placeholder
]

app.add_middleware(
    CORSMiddleware,
    allow_origins=origins,
    allow_origin_regex=r"https?://(localhost|127\.0\.0\.1|192\.168\.\d+\.\d+|10\.\d+\.\d+\.\d+|172\.(1[6-9]|2\d|3[0-1])\.\d+\.\d+)(:\d+)?|https?://.*\.ngrok-free\.app",
